...
export const sdlog = getLogger("sync");
sdlog.addContext("type", "syncd");
export const smlog = getLogger("sync");
smlog.addContext("type", "syncm");
export const stlog = getLogger("sync");
stlog.addContext("type", "synct");
export const s1log = getLogger("sync");
s1log.addContext("type", "sync1");
export const sflog = getLogger("sync");
sflog.addContext("type", "syncf");
export const ulog = getLogger("update");
ulog.addContext("type", "update");
