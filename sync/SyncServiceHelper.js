...
var SyncServiceHelper = /** @class */ (function() {
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 4:
            ...
            _b.label = 5;
          case 5:
            return [4 /*yield*/, sqls_1.next()];
          case 6:
            if (!((sqls_1_1 = _b.sent()), !sqls_1_1.done))
              return [3 /*break*/, 9];
            sql = sqls_1_1.value;
          ...
          case 11:
            ...
            if (!(sqls_1_1 && !sqls_1_1.done && (_a = sqls_1.return)))
              return [3 /*break*/, 13];
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [3 /*break*/, 5];
          case 3:
            return [4 /*yield*/, SyncServiceHelper.StagePool.connect()];
          case 4:
            _a = _b.sent();
            _b.label = 5;
          case 5:
  ...
  SyncServiceHelper.PrepareQuery = function(
    table,
    metaData,
    rows,
    filterIds,
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            columns = metaData.map(function(ele) {
              return ele.name;
            });
            ...
            sql += " ) VALUES %L";
            records_1 = [];
            filterRows = rows.filter(function(ele) {
              return filterIds.indexOf(ele[targetPk]) > -1;
            });
          ...
          case 2:
            ...
            _b.label = 3;
          case 3:
            return [4 /*yield*/, metaData_1.next()];
          case 4:
            if (!((metaData_1_1 = _b.sent()), !metaData_1_1.done))
              return [3 /*break*/, 6];
          ...
          case 8:
            ...
            if (
              !(metaData_1_1 && !metaData_1_1.done && (_a = metaData_1.return))
            )
              return [3 /*break*/, 10];
  ...
  SyncServiceHelper.ChackAvalibleQuery = function(
    table,
    metaData,
    primaryKeys,
    targetPk
  ...
  SyncServiceHelper.LocalPool = new pg_1.Pool(
    SyncServiceHelper.LocalDBOptions()
  );
  SyncServiceHelper.StagePool = new pg_1.Pool(
    SyncServiceHelper.StageDBOptions()
  );
