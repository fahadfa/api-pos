...
try {
  ...
  autoupdater.on("update.downloaded", function() {
    ...
    try {
      Log_1.log.log("warn", "net stop & start");
      cmd.run("net stop jpos-offline & sc start jpos-offline");
      Log_1.log.log("warn", "pelase wait ..........");
    } catch (err) {
  ...
  autoupdater.on("update.not-installed", function() {
    Log_1.log.warn(
      "The Update was already in your folder! It's read for install"
    );
    //autoupdater.fire("extract"); // If autoupdate: false, you'll have to do this manually
  });
