...
var MovementReport = /** @class */ (function () {
    ...
    MovementReport.prototype.execute = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var id, status_1, query, data, salesQuery, salesLine, batches, _i, batches_1, item, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!!data.originalPrinted) return [3 /*break*/, 4];
                        if (!(data.transkind == "INVENTORYMOVEMENT")) return [3 /*break*/, 4];
                        console.log("===================dffhsafyrkfhiufghllgsh================");
