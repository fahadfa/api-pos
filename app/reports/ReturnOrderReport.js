...
var ReturnOrderReport = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        batchesQuery = "select \n            distinct\n            i.itemid as itemid,\n            bs.name_en as nameEn,\n            bs.name_ar as nameAr,\n            i.qty as qty,\n            i.configid as configid,\n            i.inventsizeid as inventsizeid,\n            i.invoiceid as invoiceid,\n            i.transrefid as transrefid,\n            s.name_en as sizenameen,\n            s.name_ar as sizenamear,\n            i.batchno as batchno,\n            b.expdate as batchExpDate,\n            b.expdate as batchExpDate,\n            (select salesprice from salesline sl where sl.salesid=i.invoiceid and sl.itemid = i.itemid and sl.configid=i.configid and sl.inventsizeid=i.inventsizeid and sl.id=i.sales_line_id) as price,\n            (select lineamount from salesline sl where sl.salesid=i.invoiceid and sl.itemid = i.itemid and sl.configid=i.configid and sl.inventsizeid=i.inventsizeid and sl.id=i.sales_line_id) as \"lineAmount\",\n            (select vatamount from salesline sl where sl.salesid=i.invoiceid and sl.itemid = i.itemid and sl.configid=i.configid and sl.inventsizeid=i.inventsizeid and sl.id=i.sales_line_id) as \"vatAmount\"\n            from inventtrans  i\n        left join inventbatch b on i.batchno = b.inventbatchid\n        left join bases bs on i.itemid = bs.code\n        left join sizes s on s.code = i.inventsizeid\n        where   i.invoiceid = '" + params.salesId + "'";
                    ...
                    case 2:
                        ...
                        new_data_1.forEach(function (element) {
                            ...
                            element.lineAmount = Math.round(parseFloat((element.lineAmount * Math.pow(10, 2)).toFixed(2))) / Math.pow(10, 2);
                            i_1++;
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        salesline.totalSettledAmount = parseFloat(salesline.totalSettledAmount) + parseFloat(v.lineamount) - parseFloat(v.linetotaldisc) + parseFloat(v.vatamount);
    ...
    ReturnOrderReport.prototype.report = function (result, params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                renderData = result;
                file = params.lang == "en" ? "return-order-en" : "return-order-ar";
                try {
