        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        if (params.colorId) {
                            query += " and  sl.colorid = '" + params.colorId + "' ";
                        }
                        if (params.baseId) {
                            query += " and  bs.id = '" + params.baseId + "' ";
                        }
