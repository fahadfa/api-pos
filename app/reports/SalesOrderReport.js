                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        list_1.map(function (val) {
                            var lines = {
                                amount: parseFloat(data_1.amount).toFixed(3),
                                quantity: 0,
                                netAmount: parseFloat(data_1.netAmount).toFixed(3),
                                disc: parseFloat(data_1.disc).toFixed(3),
                                vatamount: parseFloat(data_1.vatAmount).toFixed(3),
                                page: 1,
