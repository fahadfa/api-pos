...
var OpeningBalanceService_1 = require("../services/OpeningBalanceService");
var OpeningBalanceController = /** @class */ (function () {
    function OpeningBalanceController() {
        this.componentName = "OpeningBalance";
        this.router = express_1.Router();
        this.service = new OpeningBalanceService_1.OpeningBalanceService();
    }
    OpeningBalanceController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    OpeningBalanceController.prototype.getRouter = function () {
        var _this = this;
        this.router.get("/", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var params, id, reqData, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.service.getOpeningBalance(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
    ...
    return OpeningBalanceController;
}());
