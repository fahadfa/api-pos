...
var InventtransController = /** @class */ (function () {
    function InventtransController() {
        this.router = express_1.Router();
        this.service = new InventtransService_1.InventtransService();
    }
    InventtransController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    InventtransController.prototype.getRouter = function () {
        var _this = this;
        ...
        this.router.get("/previousselectedbatches", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.service.find(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.service.sessionInfo ? this.service.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
        ...
        this.router.get("/paginate", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.router.get("/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var reqData, result, params, id, data, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 8, , 9]);
                    ...
                    case 1:
                        ...
                        if (!(reqData == "selectedbatches")) return [3 /*break*/, 3];
                        data = request.query ? request.query : {};
                        return [4 /*yield*/, this.service.getSelectedBatches(data)];
                    case 2:
                        result = _a.sent();
                        response.send({ status: 1, data: result });
                        return [3 /*break*/, 5];
    ...
    return InventtransController;
}());
exports.InventtransController = InventtransController;
