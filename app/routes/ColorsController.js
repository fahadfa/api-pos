...
var ColorsController = /** @class */ (function () {
    function ColorsController() {
        this.componentName = "Colors";
        this.router = express_1.Router();
        this.service = new ColorsService_1.ColorsService();
    }
    ColorsController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    ColorsController.prototype.getRouter = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.service.entity(id)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
        ...
        this.router.post("/uploadcsv", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var reqData, result, params, id, list, keys, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 3];
                    case 2:
                        if (reqData["file"].mimetype == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") {
                            // list = 'excel list'
                            list = excelToJson({
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this.service.save(list)];
                    case 4:
                        result = _a.sent();
