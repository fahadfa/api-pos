...
var ConfigtableService_1 = require("../services/ConfigtableService");
var ConfigtableController = /** @class */ (function () {
    function ConfigtableController() {
        this.componentName = "Products";
        this.router = express_1.Router();
        this.service = new ConfigtableService_1.ConfigtableService();
    }
    ConfigtableController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    ConfigtableController.prototype.getRouter = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(id == "salesorderpagecolors")) return [3 /*break*/, 3];
                        reqData = request.query ? request.query : {};
                        return [4 /*yield*/, this.service.searchSalesOrderColors(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 5];
    ...
    return ConfigtableController;
}());
exports.ConfigtableController = ConfigtableController;
