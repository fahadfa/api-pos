...
var ledgerJournalTransService_1 = require("../services/ledgerJournalTransService");
var LedgerJournalTransController = /** @class */ (function () {
    function LedgerJournalTransController() {
        this.componentName = "GeneralJournal";
        this.router = express_1.Router();
        this.service = new ledgerJournalTransService_1.ledgerJournalTransService();
    }
    LedgerJournalTransController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    LedgerJournalTransController.prototype.getRouter = function () {
        var _this = this;
        this.router.get("/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var reqData, result, params, id, data, count, pageCount, page, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5: return [4 /*yield*/, App_1.App.ValildateUserAccess(this.service.sessionInfo, this.moduleName(), Props_1.Props.ACCESS_READ)];
                    case 6:
    ...
    return LedgerJournalTransController;
}());
exports.LedgerJournalTransController = LedgerJournalTransController;
