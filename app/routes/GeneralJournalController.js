...
var GeneralJournalController = /** @class */ (function () {
    function GeneralJournalController() {
        this.componentName = "GeneralJournal";
        this.router = express_1.Router();
        this.service = new GeneralJournalService_1.GeneralJournalService();
    }
    GeneralJournalController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    GeneralJournalController.prototype.getRouter = function () {
        var _this = this;
        ...
        this.router.delete("/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var reqData, result, params, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
...
exports.GeneralJournalController = GeneralJournalController;
