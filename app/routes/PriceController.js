...
var PriceController = /** @class */ (function () {
    ...
    PriceController.prototype.getRouter = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        result = null;
                        App_1.App.PrintLog(this.constructor.name, "Search", this.priceService.sessionInfo);
                        reqData = request.body ? request.body.data : {};
                        return [4 /*yield*/, App_1.App.ValildateUserAccess(this.priceService.sessionInfo, this.componentName, Props_1.Props.ACCESS_READ)];
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.priceService.getPrice(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.priceService.sessionInfo ? this.priceService.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
                    case 4:
        ...
        this.router.post("/getSizePrices", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.priceService.getPrices(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.priceService.sessionInfo ? this.priceService.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
        ...
        this.router.post("/discount", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.discountService.getDiscount(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.discountService.sessionInfo ? this.discountService.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
                    case 4:
                        response.send({ status: 1, data: result });
                        return [3 /*break*/, 6];
                    case 5:
        ...
        this.router.post("/returnorderamount", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.router.post("/purchasereturnorderamount", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
