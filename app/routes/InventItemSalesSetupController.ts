...
import { InventItemSaleSetupService } from "../services/InventItemSaleSetupService";
import { App } from "../../utils/App";
import { Props } from "../../constants/Props";

export class InventItemSalesSetupController {
  private router: Router = Router();
  private service = new InventItemSaleSetupService();
