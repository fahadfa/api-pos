...
var SalestargetService_1 = require("../services/SalestargetService");
var App_1 = require("../../utils/App");
var Props_1 = require("../../constants/Props");
var SalesTargetController = /** @class */ (function () {
    function SalesTargetController() {
        this.componentName = "SalesTarget";
        this.router = express_1.Router();
        this.service = new SalestargetService_1.SalestargetService();
    }
    SalesTargetController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    SalesTargetController.prototype.getRouter = function () {
        var _this = this;
        this.router.post("/search", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
