...
import { DesignerProductsService } from "../services/DesignerProductsService";

export class DesignerProductsController {
  private router: Router = Router();
  private service = new DesignerProductsService();
