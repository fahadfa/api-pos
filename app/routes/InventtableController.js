...
var InventtableService_1 = require("../services/InventtableService");
var InventtableController = /** @class */ (function () {
    function InventtableController() {
        this.componentName = "Products";
        this.router = express_1.Router();
        this.service = new InventtableService_1.InventtableService();
    }
    InventtableController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    InventtableController.prototype.getRouter = function () {
        var _this = this;
        this.router.get("/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var params, id, result, reqData, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(id == "salesorderpageproducts")) return [3 /*break*/, 3];
                        reqData = request.query ? request.query : {};
                        return [4 /*yield*/, this.service.searchSalesOrderProducts(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.service.entity(id)];
                    case 4:
                        result = _a.sent();
                        _a.label = 5;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.service.search(id)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
    ...
    return InventtableController;
}());
exports.InventtableController = InventtableController;
