...
var TransferOrderFromAxaptaService_1 = require("../services/TransferOrderFromAxaptaService");
var TransferOrderFromAxaptaController = /** @class */ (function () {
    function TransferOrderFromAxaptaController() {
        this.componentName = "SalesLine";
        this.router = express_1.Router();
        this.service = new TransferOrderFromAxaptaService_1.TransferOrderFromAxaptaService();
    }
    TransferOrderFromAxaptaController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    TransferOrderFromAxaptaController.prototype.getRouter = function () {
        var _this = this;
    ...
    return TransferOrderFromAxaptaController;
}());
exports.TransferOrderFromAxaptaController = TransferOrderFromAxaptaController;
