...
import { InventItemPurchSetupService } from "../services/InventItemPurchSetupService";

export class InventItemPurchSetupController {
  private router: Router = Router();
  private service = new InventItemPurchSetupService();
