...
var ReceiptsController = /** @class */ (function () {
    function ReceiptsController() {
        this.router = express_1.Router();
        this.service = new ReceiptsService_1.ReceiptsService();
    }
    ReceiptsController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    ReceiptsController.prototype.getRouter = function () {
        var _this = this;
