...
var FiscalYearCloseService = /** @class */ (function () {
    function FiscalYearCloseService() {
        this.fiscalyearcloseRepository = new FiscalYearCloseDAO_1.FiscalYearCloseDAO();
        this.db = typeorm_1.getManager();
        this.rawQuery = new RawQuery_1.RawQuery();
    }
    FiscalYearCloseService.prototype.entity = function (id) {
    ...
    FiscalYearCloseService.prototype.search = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.fiscalyearcloseRepository.search(item)];
                    case 1:
                        data = _a.sent();
    ...
    FiscalYearCloseService.prototype.save = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var cond, fiscalyearcloseData, date, returnData, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.fiscalyearcloseRepository.save(item)];
                    case 2:
                        fiscalyearcloseData = _a.sent();
                        if (item.status == 1) {
    ...
    FiscalYearCloseService.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (!item.id) {
                            ...
                            filterData = previousData.filter(function (v) { return v.id != item.id && v.yearNo == item.yearNo && v.endingDate.getMonth() + 1 == item.endingDate; });
    ...
    return FiscalYearCloseService;
}());
exports.FiscalYearCloseService = FiscalYearCloseService;
