...
var AppLangService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.appLangRepository.entity(id)];
                    case 1:
                        data = _a.sent();
    ...
    AppLangService.prototype.search = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var data, returnData_1, obj, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.appLangRepository.search({})];
                    case 1:
                        data = _a.sent();
                        returnData_1 = {};
                        obj = [];
    ...
    AppLangService.prototype.save = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var cond, appLangData, returnData, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
    ...
    AppLangService.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AppLangService.prototype.validate = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var previousItem;
            return __generator(this, function (_a) {
                previousItem = null;
...
exports.AppLangService = AppLangService;
