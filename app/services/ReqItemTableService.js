...
var ReqItemTableDAO_1 = require("../repos/ReqItemTableDAO");
...
var ReqItemTableService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        query = { id: id };
                        return [4 /*yield*/, this.reqItemTableRepository.findOne(query, {
                                relations: [],
                                join: {
                                    alias: "reqItemTable",
                                    innerJoinAndSelect: {},
    ...
    ReqItemTableService.prototype.search = function (item) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ReqItemTableService.prototype.save = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var cond, reqItemTableData, returnData, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.reqItemTableRepository.save(item)];
                    case 2:
    ...
    ReqItemTableService.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.reqItemTableRepository.findOne(id)];
                    case 1:
                        data = _a.sent();
                        if (!data)
    ...
    ReqItemTableService.prototype.validate = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var previousItem;
            return __generator(this, function (_a) {
                previousItem = null;
    ...
    return ReqItemTableService;
}());
exports.ReqItemTableService = ReqItemTableService;
