...
var SyncSourceRepository_1 = require("../repos/SyncSourceRepository");
var SyncSourceService = /** @class */ (function () {
    function SyncSourceService() {
        this.syncSourceRepository = new SyncSourceRepository_1.SyncSourceRepository();
    }
    SyncSourceService.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.syncSourceRepository.entity(id)];
                    case 1:
                        data = _a.sent();
    ...
    SyncSourceService.prototype.search = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.syncSourceRepository.search(item)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data];
                    case 2:
    ...
    SyncSourceService.prototype.save = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var cond, syncSourceData, returnData, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
    ...
    SyncSourceService.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SyncSourceService.prototype.validate = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        item.id = null;
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.syncSourceRepository.entity(item.id)];
                    case 2:
    ...
    return SyncSourceService;
}());
exports.SyncSourceService = SyncSourceService;
