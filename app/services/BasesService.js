...
var BasesService = /** @class */ (function () {
    ...
    BasesService.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.basesDAO.entity(id)];
                    case 1:
                        data = _a.sent();
    ...
    BasesService.prototype.search = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var t0, items, data, t1, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
    ...
    BasesService.prototype.searchSalesOrderProducts = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        t0 = new Date().getTime();
                        return [4 /*yield*/, this.rawQuery.getStockInHandArray(this.sessionInfo.inventlocationid)];
                    case 1:
                        Items = _a.sent();
                        return [4 /*yield*/, this.basesDAO.search(params.dataareaid, Items)];
                    case 2:
