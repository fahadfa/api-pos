                ...
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        if (!((data.transkind == "TRANSFERORDER" && data.custAccount == this.sessionInfo.inventlocationid) ||
                            (data.transkind == "SALESORDER" && data.status == "SAVED"))) return [3 /*break*/, 8];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        _d.label = 5;
                    case 5:
                        if (!(_i < salesLine_8.length)) return [3 /*break*/, 9];
                        item = salesLine_8[_i];
                        delete item.id;
                        item.id = uuid();
                        item.salesId = reqData.salesId;
                        ...
                        item.lastModifiedDate = new Date(App_1.App.DateNow());
                        item.batch = [];
                        if (!(item.batches && item.batches.length > 0)) return [3 /*break*/, 6];
                        //console.log(item.batches);
                        for (_a = 0, _b = item.batches; _a < _b.length; _a++) {
                            batches = _b[_a];
                        ...
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.dofifo(item, reqData)];
                    case 7:
