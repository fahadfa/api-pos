...
var SalesTableService = /** @class */ (function () {
    ...
    SalesTableService.prototype.salesLineDelete = function (reqData, queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            var lineData, deleteList, _i, lineData_1, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (lineData) {
                            ...
                            for (_i = 0, lineData_1 = lineData; _i < lineData_1.length; _i++) {
                                i = lineData_1[_i];
                                deleteList.push(queryRunner.manager.getRepository(SalesLine_1.SalesLine).delete(i.id));
                            }
                        }
                        return [4 /*yield*/, Promise.all(deleteList)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    SalesTableService.prototype.inventryTransUpdate = function (reqData, queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            var promiseList, batches, _i, batches_3, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        promiseList = [];
    ...
    SalesTableService.prototype.salesLineItemOrder = function (item, reqData, queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            var promiseList, batches, taxItemGroup, _i, _a, batch, availability, fiofoBatches, fiofoBatches, uniqueList, groupBatchesList, qty, _b, uniqueList_1, batch;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 15: return [4 /*yield*/, this.dofifo(item, item.salesQty, reqData)];
                    case 16:
                    ...
                    case 21: return [4 /*yield*/, this.dofifo(item, item.salesQty, reqData)];
                    case 22:
                        fiofoBatches = _e.sent();
