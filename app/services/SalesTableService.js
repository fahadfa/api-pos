...
var SalesTableService = /** @class */ (function () {
    ...
    SalesTableService.prototype.saveQuotation = function (reqData, queryRunner) {
        if (queryRunner === void 0) { queryRunner = null; }
        return __awaiter(this, void 0, void 0, function () {
            var canCommitTransaction, salesLine, cond, customerRecord, customerTaxGroup, defaultcustomer, salesTable, promiseList, _i, salesLine_5, item, taxItemGroup, designerServiceData, returnData, error_11;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 5:
                        ...
                        if (!(customerRecord.walkincustomer == true)) return [3 /*break*/, 8];
                    ...
                    case 10:
                        ...
                        _a.label = 11;
                    case 11:
                        if (!(_i < salesLine_5.length)) return [3 /*break*/, 14];
                        item = salesLine_5[_i];
                        item.id = uuid();
                    ...
                    case 15:
                        _a.sent();
                        console.log("=====================================================================================");
                        if (!canCommitTransaction) return [3 /*break*/, 17];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        batches = _a.sent();
                        _i = 0, batches_6 = batches;
                        _a.label = 3;
                    case 3:
                        if (!(_i < batches_6.length)) return [3 /*break*/, 6];
                        v = batches_6[_i];
                        delete v.id;
    ...
    SalesTableService.prototype.saveReturnOrderDesignerService = function (reqData, queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            var designerservice, designerServiceAmount, _loop_2, this_1, _i, designerservice_1, item, error_13;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this_1.rawQuery.getReturnedDesignerServiceList(reqData.interCompanyOriginalSalesId)];
                                    case 1:
                                        ...
                                        return [4 /*yield*/, this_1.saveQuotation(item, queryRunner)];
                                    case 2:
                                        _a.sent();
                                        _a.label = 3;
    ...
    SalesTableService.prototype.saveSalesOrder = function (reqData) {
        return __awaiter(this, void 0, void 0, function () {
            var queryRunner, promiseList, customerRecord_1, salesLine_7, returnData, salestatus, saleslineArray, cond, customerTaxGroup, salesTable_1, _i, salesLine_6, item, salesline, condData, customerDetails, pmobileno, userName, ptokenData, pmessage, pmail, imail, error_15;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 19:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.manager.getRepository(SalesLine_1.SalesLine).save(salesLine_7)];
                    case 20:
                        salesline = _a.sent();
                        promiseList = [];
    ...
    SalesTableService.prototype.validateReturnOrder = function (reqData) {
        return __awaiter(this, void 0, void 0, function () {
            var prevReturnLines, returnLines, _loop_3, _i, returnLines_1, val, state_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SalesTableService.prototype.saveReturnOrder = function (reqData, queryRunner) {
        if (queryRunner === void 0) { queryRunner = null; }
        return __awaiter(this, void 0, void 0, function () {
            var canCommitTransaction, condition, salesLine, cond, customerRecord, customerTaxGroup, defaultcustomer, desinerService, amount, designerServiceData, promiseList, _i, salesLine_9, item, taxItemGroup, _a, _b, batches, returnData, error_18;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        canCommitTransaction = false;
                    ...
                    case 11:
                        reqData.taxGroup = customerRecord.taxgroup;
                        _c.label = 12;
                    case 12: return [4 /*yield*/, this.designerServiceDAO.search({
                    ...
                    case 13:
                        ...
                        if (!(amount >= reqData.netAmount)) return [3 /*break*/, 15];
                    ...
                    case 32:
                        ...
                        if (!canCommitTransaction) return [3 /*break*/, 34];
                        return [4 /*yield*/, queryRunner.rollbackTransaction()];
                    case 33:
                        _c.sent();
                        _c.label = 34;
                    case 34: throw error_18;
                    case 35:
                        if (!canCommitTransaction) return [3 /*break*/, 37];
                        return [4 /*yield*/, queryRunner.release()];
                    case 36:
                        _c.sent();
                        _c.label = 37;
    ...
    SalesTableService.prototype.saveOrderShipment = function (reqData) {
        return __awaiter(this, void 0, void 0, function () {
            var queryRunner, salesLine, transactionClosed, salesData, checkStatus, cond, promiseList, _i, salesLine_10, item, qty, _a, _b, batches, fiofoBatches, _c, fiofoBatches_1, inv, fiofoBatches, _d, fiofoBatches_2, inv, returnData, error_19;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 8:
                        ...
                        _e.label = 9;
                    case 9:
                        if (!(_i < salesLine_10.length)) return [3 /*break*/, 26];
                        ...
                        if (!(qty == item.salesQty)) return [3 /*break*/, 14];
                        _a = 0, _b = item.batches;
                        _e.label = 10;
                    case 10:
                        if (!(_a < _b.length)) return [3 /*break*/, 13];
                        batches = _b[_a];
                        if (!(batches.quantity > 0)) return [3 /*break*/, 12];
                        batches.itemid = item.itemid;
                        batches.transrefid = reqData.interCompanyOriginalSalesId
                            ? reqData.interCompanyOriginalSalesId
                            : reqData.salesId;
                    ...
                    case 15:
                        ...
                        _e.label = 16;
                    case 16:
                        if (!(_c < fiofoBatches_1.length)) return [3 /*break*/, 19];
                    ...
                    case 21:
                        ...
                        _e.label = 22;
                    case 22:
                        if (!(_d < fiofoBatches_2.length)) return [3 /*break*/, 25];
                    ...
                    case 31:
                        _e.sent();
                        throw error_19;
                    case 32: return [4 /*yield*/, queryRunner.release()];
                    case 33:
                        _e.sent();
                        return [7 /*endfinally*/];
    ...
    SalesTableService.prototype.saveOrderReceive = function (reqData) {
        return __awaiter(this, void 0, void 0, function () {
            var queryRunner, salesLine, transactionClosed, salesData, checkStatus, promiseList, transferData, cond, salesTable, batches_7, _i, salesLine_11, item, _a, _b, batches_8, _c, _d, batches_9, returnData, error_20;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        queryRunner = typeorm_1.getConnection().createQueryRunner();
                    ...
                    case 9:
                        ...
                        _e.label = 10;
                    case 10:
                        if (!(_i < salesLine_11.length)) return [3 /*break*/, 20];
                        ...
                        item.custAccount = reqData.custAccount;
                        item.batch = [];
                        if (!(batches_7 && batches_7.length > 0)) return [3 /*break*/, 15];
                        _a = 0, _b = item.batches;
                        _e.label = 11;
                    case 11:
                        ...
                        this.updateInventoryService.sessionInfo = this.sessionInfo;
                        return [4 /*yield*/, this.updateInventoryService.updateInventtransTable(batches_8, false, true, queryRunner)];
                    case 12:
                        _e.sent();
                        _e.label = 13;
                    case 13:
                    ...
                    case 16:
                        ...
                        batches_9 = _d[_c];
                        if (!(batches_9.quantity > 0)) return [3 /*break*/, 18];
                        delete batches_9.id;
                        ...
                        this.updateInventoryService.sessionInfo = this.sessionInfo;
                        return [4 /*yield*/, this.updateInventoryService.updateInventtransTable(batches_9, false, true, queryRunner)];
                    case 17:
                        _e.sent();
                        _e.label = 18;
                    case 18:
    ...
    SalesTableService.prototype.saveInventoryMovementOrder = function (reqData) {
        return __awaiter(this, void 0, void 0, function () {
            var queryRunner, salesLine, transactionClosed, salesData, checkStatus, promiseList, cond, _i, salesLine_12, item, _a, _b, batches, batches, _c, batches_10, batch, returnData, error_21;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        queryRunner = typeorm_1.getConnection().createQueryRunner();
