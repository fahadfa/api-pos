...
var FixedAssetTable_1 = require("../../entities/FixedAssetTable");
var FixedAssetTableDAO = /** @class */ (function () {
    function FixedAssetTableDAO() {
        this.dao = typeorm_1.getRepository(FixedAssetTable_1.FixedAssetTable);
    }
    FixedAssetTableDAO.prototype.search = function (data) {
    ...
    FixedAssetTableDAO.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FixedAssetTableDAO.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FixedAssetTableDAO.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    FixedAssetTableDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return FixedAssetTableDAO;
}());
exports.FixedAssetTableDAO = FixedAssetTableDAO;
