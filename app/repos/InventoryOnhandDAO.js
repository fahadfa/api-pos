...
var InventoryOnhandDAO = /** @class */ (function () {
    function InventoryOnhandDAO() {
        this.dao = typeorm_1.getRepository(InventoryOnhand_1.InventoryOnhand);
        this.db = typeorm_1.getManager();
    }
    InventoryOnhandDAO.prototype.search = function (data) {
    ...
    InventoryOnhandDAO.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InventoryOnhandDAO.prototype.savearr = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dao.save(data)];
    ...
    InventoryOnhandDAO.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dao
    ...
    InventoryOnhandDAO.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InventoryOnhandDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dao
    ...
    InventoryOnhandDAO.prototype.findAll = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
