...
var WorkflowDAO = /** @class */ (function () {
    function WorkflowDAO() {
        this.dao = typeorm_1.getRepository(Workflow_1.Workflow);
    }
    WorkflowDAO.prototype.search = function (data) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.dao
                                ...
                                .leftJoin("Workflow.selectedLines", "selectedLines")
    ...
    WorkflowDAO.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    WorkflowDAO.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    WorkflowDAO.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    WorkflowDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
