...
var InventSize_1 = require("../../entities/InventSize");
var InventsizeDAO = /** @class */ (function () {
    function InventsizeDAO() {
        this.dao = typeorm_1.getRepository(InventSize_1.Inventsize);
    }
    InventsizeDAO.prototype.search = function (data, items) {
    ...
    InventsizeDAO.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InventsizeDAO.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InventsizeDAO.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InventsizeDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return InventsizeDAO;
}());
exports.InventsizeDAO = InventsizeDAO;
