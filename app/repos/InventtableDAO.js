...
var Inventtable_1 = require("../../entities/Inventtable");
var InventtableDAO = /** @class */ (function () {
    function InventtableDAO() {
        this.dao = typeorm_1.getRepository(Inventtable_1.Inventtable);
    }
    InventtableDAO.prototype.search = function (data, items) {
    ...
    InventtableDAO.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InventtableDAO.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InventtableDAO.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InventtableDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
